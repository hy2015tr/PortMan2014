...
{
    public partial class FrmPageAlcatel : XtraForm
    {
        //-----------------------------------------------------------------------------------------------------------------------------------------//

        public FrmPageAlcatel()
        {
            // Initialize
            InitializeComponent();
        ...
        {
            // Fill Values
            alfaEntity.Fill_ComboBox_Field(txtSiteNameV1, true, "TableRouterAlcatel", "SiteName");
            alfaEntity.Fill_ComboBox_Field(txtSiteNameV2, false, "TableRouterAlcatel", "SiteName");
        ...
        private void btnReservList_Click(object sender, EventArgs e)
        {
            ...
            // GetList
            var p_Result = alfaEntity.TablePortAvea_GetList("ALCATEL", txtSiteNameV1.Text, txtPortStatus.Text);

            // SetView
            alfaGrid.SetView(grdReservView, (object)p_Result, false);

            // Hide Columns
            alfaGrid.ColumnHide(grdReservView, "Logs-UpdateDatetime-UpdateUsername-PortType-PRTType");
        ...
        private async void btnRefreshPorts_Click(object sender, EventArgs e)
        {
            ...
            // Start Process
            alfaNET.Start(MainTimer, alfaNET.FrmMain.pageAlcatel);
            ...
            // Get Router
            var p_Router = alfaEntity.TableRouterAlcatel_Get(txtSiteNameV1.Text);

            // Get Ports
            if (await alfaNET.F1_Alcatel_GetRouterPorts_Task(p_Router, grdPortView, txtTerminal))
            {
                // Save List
                await alfaEntity.TablePortAvea_SaveAlcatel_Task((List<PortAvea>)grdPort.DataSource, p_Router);
        ...
        private void btnPorts_Click(object sender, EventArgs e)
        {
            ...
            // Router
            var p_Router = alfaEntity.TableRouterAlcatel_Get(txtSiteNameV2.Text);

            // Set Connection
            p_Router.Connection = txtConnection.Text;

            // Get Ports
            alfaNET.F2_Alcatel_GetRouterPorts(p_Router, grdPortView, txtTerminal);
        ...
        private void grdReservView_RowCellStyle(object sender, RowCellStyleEventArgs e)
        {
            ...
            if ("Status".Contains(e.Column.FieldName))
            {
                ...
                else if (p_CellValue == alfaStr.DELETED) e.Appearance.BackColor = Color.LightGray;
            }
        }
        ...
        {
            // Router
            var p_Router = alfaEntity.TableRouterCisco_Get(txtSiteNameV2.Text);

            // Update Connection
            alfaEntity.TableRouterAlcatel_UpdateConnection(p_Router.SiteName, txtConnection.Text);
        ...
        private void btnRequest_Click(object sender, EventArgs e)
        {
            ...
            {
                // Set ReqUser
                p_Port.RequestUser = alfaSession.UserName;
            ...
            // SendMail
            alfaMail.Send(p_To, alfaSession.Email, "PortMan2014 - Ports Requested / ALCATEL", "Please Check With Attached File ... !", grdReservView);
        ...
        private void btnReserv_Click(object sender, EventArgs e)
        {
            ...
            // Reserve Ports
            if (alfaNET.F4_Alcatel_ReservePorts_SSH(p_List))
            {
                // Selected List
                grdReserv.DataSource = p_List;
                ...
                // SendMail
                alfaMail.Send(p_To, alfaSession.Email, "PortMan2014 - Ports Reserverd / ALCATEL", "Please Check With Attached File ... !", grdReservView);
        ...
        private void btnReservCancel_Click(object sender, EventArgs e)
        {
            ...
            // Reserve Ports
            alfaNET.F5_Alcatel_RollbackPorts_SSH(p_List);
