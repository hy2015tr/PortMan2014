...
{
    public partial class FrmPageCisco : XtraForm
    {
        //-----------------------------------------------------------------------------------------------------------------------------------------//
        ...
        {
            // Fill Values
            alfaEntity.Fill_ComboBox_Field(txtSiteNameV1, true, "TableRouterCisco", "SiteName");
            alfaEntity.Fill_ComboBox_Field(txtSiteNameV2, false, "TableRouterCisco", "SiteName");
        ...
        private void btnReservList_Click(object sender, EventArgs e)
        {
            ...
            // GetList
            var p_Result = alfaEntity.TablePortAvea_GetList("CISCO", txtSiteNameV1.Text, txtPortStatus.Text);
        ...
        private async void btnRefreshPorts_Click(object sender, EventArgs e)
        {
            ...
            // Start Process
            alfaNET.Start(MainTimer, alfaNET.FrmMain.pageCisco);
            ...
            // Get Router
            var p_Router = alfaEntity.TableRouterCisco_Get(txtSiteNameV1.Text);

            // Get Ports
            if (await alfaNET.F1_Cisco_GetRouterPorts_Task(p_Router, grdPortView, txtTerminal))
            {
                // Save List
                await alfaEntity.TablePortAvea_SaveCisco_Task((List<PortAvea>)grdPort.DataSource, p_Router);
        ...
        private void btnPorts_Click(object sender, EventArgs e)
        {
            ...
            // Get Ports
            alfaNET.F2_Cisco_GetRouterPorts(p_Router, grdPortView, txtTerminal);
        ...
        private void btnUpdateConnection_Click(object sender, EventArgs e)
        {
            ...
            // Update Connection
            alfaEntity.TableRouterCisco_UpdateConnection(p_Router.SiteName, txtConnection.Text);
        ...
        private void btnRequest_Click(object sender, EventArgs e)
        {
            ...
            // SendMail
            alfaMail.Send(p_To, alfaSession.Email, "PortMan2014 - Ports Requested / CISCO", "Please Check With Attached File ... !", grdReservView);
        ...
        private void btnReserv_Click(object sender, EventArgs e)
        {
            ...
            // Reserve Ports
            if (alfaNET.F4_Cisco_ReservePorts_SSH(p_List))
            {
                // Selected List
                grdReserv.DataSource = p_List;
                ...
                // SendMail
                alfaMail.Send(p_To, alfaSession.Email, "PortMan2014 - Ports Reserverd / CISCO", "Please Check With Attached File ... !", grdReservView);
        ...
        private void btnReservCancel_Click(object sender, EventArgs e)
        {
            ...
            // Reserve Ports
            alfaNET.F5_Cisco_RollbackPorts_SSH(p_List);
